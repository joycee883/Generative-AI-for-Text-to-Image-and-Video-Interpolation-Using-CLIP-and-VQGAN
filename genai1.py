...
Original file is located at
    https://colab.research.google.com/drive/19LPopkqyTqw0qAF0XvOWEVtX2TD06vxq
"""
...
# Remove the existing CLIP directory (if any)
!rm -rf CLIP
...
# Remove the existing taming-transformers directory (if any)
...
# Update the path to include the full path from the root directory
...
torch.cuda.empty_cache()
include=['MILKY WAY GALAXY','SOLAR SYSTEM WITH NINE PLANETS']
exclude='watermark'
extras = ""
w1=1
w2=1
...
torch.cuda.empty_cache()
include=['SUNFLOWER GARDEN','MILKYWAYGALAXY','SOLAR SYSTEM WITH NINE PLANETS']
exclude='watermark'
extras = ""
w1=1
w2=1
